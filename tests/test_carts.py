...
# =========================================================================
class TestCartAPI:
    def test_add_own_product_forbidden(self, client, app):
    ...
    def test_add_item_to_cart_success_and_stock_guard(self, client, app):
    ...
    def test_view_and_update_cart(self, client, app):
    ...
    def test_clear_cart(self, client, app):
    ...
    def test_add_invalid_quantity_to_cart(self, client, app):
