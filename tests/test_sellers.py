...
# =========================================================================
class TestSellerAPI:
    def test_create_store_success_and_duplicate(self, client, app):
    ...
    def test_create_store_name_conflict(self, client, app):
    ...
    def test_get_store_profile(self, client, app):
    ...
    def test_update_and_delete_store(self, client, app):
