...
# TEST CASES
# =========================================================================
def test_checkout_split_order(client, app):
...
def test_buyer_cancel_order(client, app):
...
def test_seller_forbidden_to_cancel(client, app):
...
def test_idor_prevent_buyer_accessing_others_order(client, app):
...
def test_checkout_ghost_product(client, app):
